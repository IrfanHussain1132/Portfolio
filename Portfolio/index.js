document.addEventListener('DOMContentLoaded', function() {
    ...
    card.addEventListener('click', function() {
        ...
        setTimeout(function() {
            ...
            const sodhiPara = document.querySelector('.sodhi h1');
            if (j % 2 !== 0) {
                sodhiPara.style.color = '#f0c14b'; 
            } else {
                sodhiPara.style.color = '#18b400'; 
            }
...
document.getElementById('contact').addEventListener('click', function() {
    ...
    setTimeout(function() {
        ...
        const icons = document.querySelectorAll('.bott i');
        
        icons.forEach(function(icon) {
            icon.classList.add('enlarge');
        });
        
        setTimeout(function() {
            icons.forEach(function(icon) {
                icon.classList.remove('enlarge');
            });
        }, 1900);
    }, 1000);
});
